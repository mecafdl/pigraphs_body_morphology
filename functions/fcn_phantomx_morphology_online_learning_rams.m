...
function lambda_hat_online = fcn_phantomx_morphology_online_learning_rams(hexapodProprioception,parents, children, constPar)
    close all
       
    signals = [hexapodProprioception.jointPosition.zeroPhaseFilter; ...
               hexapodProprioception.jointVelocity.zeroPhaseFilter; ...
               hexapodProprioception.jointTorque.zeroPhaseFilter; ...
               hexapodProprioception.bodyAngularVelocity.zeroPhaseFilter; ...
               NaN(size(hexapodProprioception.bodyAngularVelocity.raw)); ...
               hexapodProprioception.bodyAngularAcceleration.zeroPhaseFilter; ...
               hexapodProprioception.bodyLinearAcceleration.zeroPhaseFilter];
    ...
    signals_maf(ang_acc_indices,:) = gradient(signals_maf(ang_vel_indices,:),1E-2);
    ...
    for p = 1:13
        subplot(3,5,p)
        plot(1:size(lambda_rams_mav,3),permute(lambda_rams_mav(8:13,p,:),[1,3,2]))
        ylabel(['$\boldmath{\lambda}_' num2str(p), '(t)$'],'interpreter','latex')
        xlabel(['Time [s]'])
    end
