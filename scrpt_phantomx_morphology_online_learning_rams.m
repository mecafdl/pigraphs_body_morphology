...
% dq_indices       = 8:14;
% ddq_indices      = 15:21;
% ang_vel_indices  = 22:45;
% lin_vel_indices  = 46:69;
% ang_acc_indices  = 70:93;
% lin_acc_indices  = 94:117;
...
% signals = [q_phantomx(:,sample_points); ...
%            dq_phantomx(:,sample_points); ...
%            actions(:,sample_points); ...
%            ang_vel_imu; ...
%            lin_vel_imu; ...
%            ang_acc_imu_num_zpf; ...
%            lin_acc_imu];

signals = proprioception;

% B       = 1/100*ones(1,100);
% A       = 1; %denominator coefficients
% signals = transpose(filter(B,A,transpose(signals)));
