function out = VisualizeBoundCircle(X,R,C,color,falpha,ha)
...
%     H(2)=plot(x,y,'--','Color',color,'LineWidth',0.5);
    H(2)=plot(x,y,'-.','Color','k','LineWidth',1);
    f = fill(x, y, color,'LineStyle','none');
    f.FaceAlpha = falpha;
