...
% Load the dataset
% armProprioceptionSimulated = fcn_loadRobotArmData();
load('./data/armProprioceptionSimulated.mat')

MOVING_BASE = 1;
if ~MOVING_BASE
    proprioception = [armProprioceptionSimulated.fixedBase.jointPosition; ...
                      armProprioceptionSimulated.fixedBase.jointVelocity; ...
                      armProprioceptionSimulated.fixedBase.jointTorque; ...
                      armProprioceptionSimulated.fixedBase.bodyAngularVelocity; ...
                      armProprioceptionSimulated.fixedBase.bodyLinearVelocity; ...
                      armProprioceptionSimulated.fixedBase.bodyAngularAcceleration; ...
                      armProprioceptionSimulated.fixedBase.bodyLinearAcceleration
                      ];
else
    proprioception = [armProprioceptionSimulated.movingBase.jointPosition; ...
                      armProprioceptionSimulated.movingBase.jointVelocity; ...
                      armProprioceptionSimulated.movingBase.jointTorque; ...
                      armProprioceptionSimulated.movingBase.bodyAngularVelocity; ...
                      armProprioceptionSimulated.movingBase.bodyLinearVelocity; ...
                      armProprioceptionSimulated.movingBase.bodyAngularAcceleration; ...
                      armProprioceptionSimulated.movingBase.bodyLinearAcceleration
                      ];
end
...
for loop = 1:total_runs
    ...
    [lambda_hat_online_float, ~, J_log(:,loop)] = ...
        fcn_robot_kinematics_rams_online_learning(propioceptiveSignals, ...
                                                  ...
                                                  buffer, ...
                                                  BATCH_SIZE, ...
                                                  armProprioceptionSimulated.samplingTime, ...
                                                  constPar);
end
